...
const MobileOptimizedLayout = ({ children }: MobileOptimizedLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Sleek Mobile Header */}
      <div className="lg:hidden bg-white border-b border-gray-200 sticky top-0 z-40 backdrop-blur-sm bg-white/95">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-[#007144] rounded-lg flex items-center justify-center">
